...
<head>
  ...
  <meta name="description" content="Register domains with Quizontal Cloud — live availability search, free WHOIS privacy and transparent LKR pricing, managed from the same clean dashboard as your VPS.">
  <title>Quorizontal Cloud — Domains with free privacy & LKR pricing</title>
...
<main id="top">
  <section class="hero container domain-hero" id="find">
    <div class="domain-hero-copy">
      <div class="eyebrow"><span></span> Domain names · LKR pricing</div>
      <h1>Claim your name<br><em>before someone else does.</em></h1>
      <p>Search live availability, register in a couple of clicks, and manage DNS next to your cloud servers — all from the same Quizontal Cloud dashboard you already know.</p>
      <form class="domain-search" id="domainSearchForm" role="search">
        <div class="domain-search-box">
          <span class="domain-search-icon">◎</span>
          <input id="domainSearchInput" type="text" inputmode="url" autocomplete="off" spellcheck="false" placeholder="yourname.com" aria-label="Domain name to search">
      ...
      <div class="domain-result" id="domainResult" hidden></div>
      <div class="domain-hero-proof">
        <div><strong>Free</strong><span>WHOIS privacy on supported extensions</span></div>
        <div><strong>Live</strong><span>Real-time availability at the registry</span></div>
        <div><strong>Rs.</strong><span>Pay by bank transfer into your wallet</span></div>
      </div>
    </div>
  </section>

  <section class="section container" id="prices">
    <div class="section-intro"><div><span class="section-kicker">Transparent pricing</span><h2>Domain prices, no surprises</h2></div><p>Registration and renewal prices per year in Sri Lankan Rupees, synced from our billing system. What you see is what you pay.</p></div>
  ...
  <section class="section container" id="domain-steps"><div class="center-intro"><span class="section-kicker">Simple from day one</span><h2>From idea to domain in minutes</h2></div><div class="steps-grid">
    <article><span>01</span><div class="step-icon">◎</div><h3>Search and pick</h3><p>Check live availability above and choose the extension that fits your project.</p></article>
  ...
  <section class="section container" id="domain-faq"><div class="faq-layout"><div><span class="section-kicker">Frequently asked</span><h2>Domain questions, answered</h2><p>Everything about registering, renewing and moving domains with Quorizontal Cloud.</p><a id="faqClientArea" href="/client-area" class="button button-ghost">Contact support</a></div><div class="faq-list">
    ...
    <details><summary>What does a renewal cost?<span>+</span></summary><p>The renewal price for every extension is listed in the pricing table above before you buy — no inflated second-year surprises.</p></details>
